...
const navigationLinks = [
  ...
  { href: "/admin", label: "Dashboard", role: role.superAdmin as const },
  { href: "/admin", label: "Dashboard", role: role.admin as const },
  { href: "/agent", label: "Dashboard", role: role.agent as const },
  { href: "/user", label: "Dashboard", role: role.user as const },
];
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b-2 border-gray-300 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 dark:bg-gradient-to-r dark:from-black dark:via-emerald-900 dark:to-black backdrop-blur-xl">
